...
// CardHeader: text props, image rpops
function CardHeader({ name, description}) {
  return (
    <header className="flex flex-col">
        {/* In middle visually */}
        <CardHeaderTextBox name={name} description={description} />
...
// CardHeaderTextBox
function CardHeaderTextBox(name, description) {
  return (
...
// CardButtons: link prop, text prop, style prop
